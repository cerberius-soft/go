...
// Response ErrorResponse - Generic error response
//
...
func (m *Response) validateError(formats strfmt.Registry) error {
...
func (m *Response) contextValidateError(ctx context.Context, formats strfmt.Registry) error {
